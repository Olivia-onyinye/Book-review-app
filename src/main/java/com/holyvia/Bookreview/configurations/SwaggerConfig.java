...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "Book Review",
                "An api for tracking and review/rating of Books read by users",
                "1.0",
                "Free to use and authenticate for protected endpoints",
                new Contact("Book Review", "www.holyviabookreview.com", "holyviabookreview@gmail.com"),
                "License of API", "www.holyviabookreview.com", Collections.emptyList());
    }
