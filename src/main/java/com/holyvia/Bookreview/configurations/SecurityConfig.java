...
import com.holyvia.Bookreview.configurations.jwt.JWTCoder;
...
import static com.holyvia.Bookreview.enums.Role.ADMIN;
import static com.holyvia.Bookreview.enums.Role.USER;
...
public class SecurityConfig {
    ...
    private final String[] WHITE_LISTED_URLS = { "/", "/home", "index", "/css/*", "/js/*", "/api/v1/auth/**","/v2/api-docs/**",
            ...
            "/swagger-ui.html", "/api/v1/user/signup","/api/v1/verifyRegistration/**", "/api/v1/admin/signup",
    };
